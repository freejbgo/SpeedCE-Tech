...
def generate_llms_txt(articles: list[dict]) -> str:
    lines = [
        ...
        "> 工具官网：https://www.speedce.com | 站长论坛：https://bbs.speedce.com",
...
def generate_json_index(articles: list[dict]) -> str:
    payload = {
        "name": "SpeedCE 技术文档库",
        "description": "210+ 篇网站测速、故障排查、VPS 验线路、CDN 验收实战长文；SpeedCE 支持 HTTP/HTTPS/PING/TCPing/DNS/Traceroute",
        "repository": f"https://github.com/{GITHUB_REPO}",
        "pages_base": PAGES_BASE,
        "tool": {
            "name": "SpeedCE",
            "url": "https://www.speedce.com",
            "app_url": "https://speedce.com",
